# PathoBase
An open database for storing and processing the genomes of multiple pathogens, providing genomic information including dcgMLST typing[1][ref1], genome annotation, and plasmid prediction.
